...
import ai.vital.mldemo.utils.XMLChar
import com.hp.hpl.jena.rdf.model.ResourceFactory

object TwentyNewsDataToNQuads {
    ...
    def main(args: Array[String]): Unit = {
      ...
      val inputOption = new Option("i", "input-dir", true, "input twnety news root dir parent of both 20news-bydate-test and 20news-bydate-train")
      ...
      if (args.length == 0) {
        ...
        hf.printHelp(TwentyNewsDataToNQuads.getClass.getCanonicalName, options)
        return
      }
